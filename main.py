...
bot_token = os.environ.get("TOKEN","6975037101:AAEqfHYaZNBud2OjCKTJz69CrjQhKEST2JA") # Botunuzun Tokenini Girin.
sahib = os.environ.get("sahib", "JESSuuy") # Sahiplik Hesabin Kullanıcı Adını Girin .
BOT_ID = int(os.environ.get("BOT_ID", "6975037101")) # Botunuzun İd'si ( Tokenin Başındaki Rakamları ) Girin .
DATABASE_URL = os.environ.get("DATABASE_URL","") # MongoDB veritabanınızın url'si.
BOT_USERNAME = os.environ.get("BOT_USERNAME","Jesi_0_bot") # Botunuzun kullanıcı adı.
...
OWNER_ID = int(os.environ.get("OWNER_ID","5428867320")) # Sahip hesabın id'si
